/*
	TITLE			Unordered map		 	  Chapter21TryThis5.cpp
	"Bjarne Stroustrup "C++ Programming: Principles and Practice.""
	COMMENT
		 Objective: Write a small program using #include <unordered_map>.   
		     Input: -
			Output: -
...
int main()
{
	try
	{
		...
		typedef std::unordered_map<std::string, double>::const_iterator Dow_iterator;

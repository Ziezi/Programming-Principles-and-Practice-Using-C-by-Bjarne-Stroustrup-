/*
	TITLE		   Secure communication using TEA			 Chapter25Exercise13.h
	COMMENT
...
#ifndef Chapter25Exercise13_h
#define Chapter25Exercise13_h

/*
	Function: encipher(src, dest, key)

	src - eight (2 words or 2*4 bytes) characters to be enciphered.
	dest- enciphtered output. key - array of 4 words.
...
/*
	...
	src - 2 encrypted words; dest - 2 decrypted words.

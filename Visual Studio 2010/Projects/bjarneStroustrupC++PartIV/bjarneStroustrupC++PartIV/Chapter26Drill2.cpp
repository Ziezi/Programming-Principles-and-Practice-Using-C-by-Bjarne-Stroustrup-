/* 
	TITLE		   Test Cases     				 Chapter26Drill2.cpp
	COMMENT
		Objective: Complete a file of tests for the sequence from §26.3.
			Input: -
		   Output: -
...
int main()
{
	try
	{
		std::string ifile("Chapter26Drill2Tests.txt");

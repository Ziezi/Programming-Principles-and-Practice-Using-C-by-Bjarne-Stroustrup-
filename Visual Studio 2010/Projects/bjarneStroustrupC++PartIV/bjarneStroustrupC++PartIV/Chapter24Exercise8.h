/*
	TITLE		   Animate the Gaussian Elimination  Chapter24Exercise8.h
	COMMENT
		Objective: Animate the Gaussian Elimination. 
		   ...
		   Author: Chris B. Kirov
			 Date: 07.05.2017
*/
#ifndef Chapter24Exercise8_h
#define Chapter24Exercise8_h
...
void classical_elimination(Matrix& A, Vector& b)
{
	...
	for (int j = 0; j < n - 1; ++j)
	{
		...
		for (int i = j + 1; i < n; ++i)
		{
			...
			std::cout <<"L"<< i + 1 <<" - "<<"L"<< j + 1 <<" * "<< multiplier <<" -> "<<"L"<< i + 1 <<'\n';

/*
	TITLE		   Read a data file and plot  	  Chapter15Exercise8.cpp
	"Bjarne Stroustrup "Programming Principles and Practices Using C++""
	COMMENT
		Objective: Read a data file containig heights in cm 
...
int main()
{
	try
	{
		 ...
		 std::string file_name("Chapter15Exercise8.txt");
		 ...
		 Simple_window sw(Point(500, 0), width, height, "Chapter 15 Exercise 8");

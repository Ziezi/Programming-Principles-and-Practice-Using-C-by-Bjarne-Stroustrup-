/*
	TITLE			  Add variable reassignment	 Chapter7Exercise2Def.cpp
	Bjarne Stroustrup "Programming: Principles and Practice Using C++"
	COMMENT
			Objective: Allow reassignment of already defined variables.
				Input: -
			   Output: -
...
double primary()
{
	...
	switch (t.kind)
	{
		...
		case nameIdentifier:
		{
			// New code: checks whether variable exists and if so it reassigns a new value
			Token t2 = ts.get();

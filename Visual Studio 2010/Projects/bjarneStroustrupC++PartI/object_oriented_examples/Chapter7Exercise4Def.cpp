/*
	TITLE			   Define Symbol Table	  Chapter7Exercise4Def.cpp
	Bjarne Stroustrup "Programming: Principles and Practice Using C++"
	COMMENT
			Objective: Define a class Symbol_table to hold and manipulate
...
double declaration()
{
	...
	if (t.name == constantVariableKeyword)
	{
		...
		// New code
		if (st.is_declared(newConstantVarariableName))
		{
		...
		st.add(constantVariableIdentifier, newConstantVarariableName, constantVariableValue);
	...
	else
	{
		...
		st.add(variableIdentifier, newVariableName , neVariableValue);

/*
	TITLE			   Define Symbol Table	       Chapter7Exercise4.h
	...
	COMMENT
			Objective: Define a class Symbol_table to hold and manipulate
			   ...
			   Author: Chris B. Kirov
			     Date: 25.02.2015
*/
#ifndef CHAPTER7EXERCISE4_H
#define CHAPTER7EXERCISE4_H
...
//------------------------------------------------------------------------------------------
// Declaration of class used to manipulate user defined variables
/*
	class Symbol_table
...
#include "Chapter7Exercise4Def.cpp"
